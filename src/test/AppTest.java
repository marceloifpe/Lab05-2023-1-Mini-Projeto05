...
public class AppTest {
    ...
    public void testSelecao() {
        ...
        assertEquals(arrayOrdenado, o.ordene(array));
        int[] array2 = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
        int[] arrayOrdenado2 = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
        assertEquals(arrayOrdenado2, o.ordene(array2));
        int[] array3 = { 8, 7, 6, 5, 4, 3, 2, 1, 0 };
        int[] arrayOrdenado3 = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
        assertEquals(arrayOrdenado3, o.ordene(array3));
        int[] array4 = { 0 };
        int[] arrayOrdenado4 = { 0 };
        assertEquals(arrayOrdenado4, o.ordene(array4));
        int[] array5 = { 5, 3, 2, 4, 7, 2, 0, 7 };
        int[] arrayOrdenado5 = { 0, 2, 2, 3, 4, 5, 7, 7 };
        assertEquals(arrayOrdenado5, o.ordene(array5));
    }
    ...
    public void testMerge() {
        ...
        assertEquals(r2, m.merge(array3, array4));
